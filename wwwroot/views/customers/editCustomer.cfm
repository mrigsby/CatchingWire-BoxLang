<cfoutput>
	...
	<div class="card card-success card-outline mb-4">
		...
		<div class="card-header">
			<div class="card-title">Edit #prc.oUser.getFname()# #prc.oUser.getLname()#</div>
		</div>

		<form novalidate="" name="frmEditCustomer" id="frmEditCustomer" method="post" action="">
			...
			<div class="card-body">
				...
				<div class="row g-3">
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" id="fname" name="fname" value="#prc.oUser.getFName()#" required="">
						<div class="invalid-feedback">First Name is required.</div>
					</div>

					<div class="col-md-6">
						<label for="lname" class="form-label">Last name</label>
						<input type="text" class="form-control" id="lname" name="lname" value="#prc.oUser.getLName()#" required="">
						<div class="invalid-feedback">Last Name is required.</div>
					</div>

					<div class="col-md-12">
						<label for="title" class="form-label">Title</label>
						<input type="text" class="form-control" id="title" name="title" value="#prc.oUser.getTitle()#">
					</div>
	...
	<script>
		...
		( () => {
			...
			const myAccountForm = document.getElementById('frmEditCustomer');
			myAccountForm.addEventListener( 'submit', (event) => {
				...
				fetch( '#event.buildLink( "customers.#prc.oUser.getID()#" )#', {
					method: 'POST',
	...
	<script>
		( () => {
			...
			changePassForm.addEventListener( 'submit', (event) => {
				...
				fetch( '#event.buildLink( "customers.#prc.oUser.getID()#.change-password" )#', {
					method: 'POST',
