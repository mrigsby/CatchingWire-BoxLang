component {
	...
	function configure(){
		...
		coldbox = {
			// Application Setup
			appName                  : getSystemSetting( "APPNAME", "CatchingWire" ),
			eventName                : "event",
		 ...
		 */
		settings = {
			userPreferenceDefaults : structNew("ordered")
		};
		userPreferenceDefaults[ "ui" ] = {
			"label"			:	"User Interface ",
			"description"	:	"Settings that modify look and feel of the OMS",
			"settings"		:	[
				{
					"label"		: "Top Pagination",
					"desc"		: "Display pagination on most tables at the top as well as the bottom.isValid",
					"type"		: "boolean",
					"key"		: "UI_PAGINATION_TOP",
					"default"	: false
				}
			]
		};
